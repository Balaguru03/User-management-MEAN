...
demo(): Observable<any>{
  let httpOptions = {
    headers: new HttpHeaders({
      'Content-Type': 'application/json',
      'Authorization': 'Basic ' + btoa('XSADEV13:Balaguru@97')
    })
  };
  return this.http.get(`${environment.api.xsaUrl}xsodata/purchaseOrder.xsodata/POHeader?$expand=POItem`,httpOptions)
}
// xsodata/user.xsodata/Users/$format=json
}
